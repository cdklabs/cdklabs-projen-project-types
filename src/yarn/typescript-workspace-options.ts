...
import { github, javascript, IgnoreFileOptions, GitOptions, LoggerOptions, ProjectType, ProjenrcOptions, typescript, SampleReadmeProps, release, RenovatebotOptions } from 'projen';
import { yarn } from '../';
