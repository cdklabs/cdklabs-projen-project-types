...
import { github, javascript, IgnoreFileOptions, GitOptions, LoggerOptions, ProjectType, ProjenrcJsonOptions, typescript, SampleReadmeProps, ReleasableCommits, release, RenovatebotOptions } from 'projen';
import { yarn } from '../';
