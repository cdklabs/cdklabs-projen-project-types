...
import { github, javascript, IgnoreFileOptions, GitOptions, LoggerOptions, ProjectType, ProjenrcJsonOptions, typescript, SampleReadmeProps, release, RenovatebotOptions } from 'projen';
import { yarn } from '../';
