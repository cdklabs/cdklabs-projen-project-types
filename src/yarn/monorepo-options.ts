...
import { github, javascript, IgnoreFileOptions, GitOptions, LoggerOptions, Project, ProjectType, ProjenrcJsonOptions, typescript, SampleReadmeProps, ReleasableCommits, release, RenovatebotOptions, GroupRunnerOptions } from 'projen';
import { yarn } from '../';
...
`addBranch()` to add additional branches.
   ...
   */
  readonly releaseOptions?: yarn.MonorepoReleaseOptions;
  /**
